...
namespace Nop.Services.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<T> LoadSettingAsync<T>(int storeId = 0, int vendorId = 0) where T : ISettings, new();
        ...
        /// <param name="vendorId">Vendor identifier for which settings should be loaded</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task<ISettings> LoadSettingAsync(Type type, int storeId = 0 , int vendorId = 0);
        ...
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SetSettingAsync<T>(string key, T value, int storeId = 0,int vendorId = 0, bool clearCache = true);
        ...
        /// The task result contains the setting
        /// </returns>
        Task<Setting> GetSettingAsync(string key, int storeId = 0, int vendorId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// <param name="settings">Setting instance</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task SaveSettingAsync<T>(T settings, int storeId = 0 , int vendorId = 0) where T : ISettings, new();
